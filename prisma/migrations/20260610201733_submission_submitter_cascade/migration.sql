...
CREATE TABLE "new_submissions" (
    ...
    "allow_overlapping_placements" BOOLEAN NOT NULL DEFAULT false,
    ...
    CONSTRAINT "submissions_submitter_id_fkey" FOREIGN KEY ("submitter_id") REFERENCES "conference_identities" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO "new_submissions" ("allow_overlapping_placements", "conference_id", "created_at", "description", "id", "manually_finished", "max_placements", "pre_assigned_room_id", "status", "submitter_id", "title") SELECT "allow_overlapping_placements", "conference_id", "created_at", "description", "id", "manually_finished", "max_placements", "pre_assigned_room_id", "status", "submitter_id", "title" FROM "submissions";
