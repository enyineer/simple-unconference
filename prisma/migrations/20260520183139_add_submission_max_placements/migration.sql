-- AlterTable
ALTER TABLE "conferences" ADD COLUMN "submission_max_placements_default" INTEGER DEFAULT 1;
...
INSERT INTO "new_submissions" ("conference_id", "created_at", "description", "id", "status", "submitter_id", "title") SELECT "conference_id", "created_at", "description", "id", "status", "submitter_id", "title" FROM "submissions";
