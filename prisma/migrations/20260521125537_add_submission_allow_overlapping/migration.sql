...
INSERT INTO "new_submissions" ("conference_id", "created_at", "description", "id", "manually_finished", "max_placements", "pre_assigned_room_id", "status", "submitter_id", "title") SELECT "conference_id", "created_at", "description", "id", "manually_finished", "max_placements", "pre_assigned_room_id", "status", "submitter_id", "title" FROM "submissions";
